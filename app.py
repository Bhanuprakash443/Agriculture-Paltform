...
from models.disease_detection.model_handler import DiseaseDetectionModel
from models.crop_recommendation.crop_model import CropRecommendationModel
from models.fertilization.fertilizer_model import FertilizerModel
from models.govt_schemes.schemes_handler import GovtSchemesModel
...
def load_models():
    try:
        ...
        # Load your actual model files using relative paths
        disease_model.load_model('models/model.h5')
        crop_model.load_model('models/label_encoder.pkl')
        fertilizer_model.load_data('data/ideal_npk_ph_values_india.csv')
        schemes_model.load_data('data/farmer_schemes_dataset.csv')
        print("Models loaded successfully!")
        return True
    except Exception as e:
        print(f"Error loading models: {e}")
